...
<head>
    ...
    <title>vos Commandes de <?php echo ($boutique->getNomBoutique()) ?></title>
</head>
...
<body>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Gerez vos Commandes ici</span>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card l-bg-blue-dark">
                                <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="mb-4">
                                        <h5 class="card-title mb-0">Nombre de commandes</h5>
                                    </div>
                                    <div class="row align-items-center mb-2 d-flex">
                                        <div class="col-8">
                                            <h2 class="d-flex align-items-center mb-0 nbrCommande">
                                                --
                                            </h2>
                                        </div>
                ...
                <div class="btnZone">
                    <a href="../extern_public/ajouter_commande.php" title="Ajouter une vente">Nouvelle Commande</a>
                </div>

                <div class="inputZone">

                    <div class="inputs">
                        <input type="text" placeholder="entrer le nom du client" class="searchInput">
                    ...
                    <table id="example" style="width:100%" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="titleTab3">Adresse</th>
                                <th class="titleTab3">Nbre Produit</th>
                                <th class="titleTab3">type</th>
                                <th class="titleTab3">total</th>
                                <th class="titleTab3">Voir</th>
                                <th class="titleTab6">Valider</th>
                                <th class="titleTab6">Action</th>
                            </tr>
                        </thead>
                        <tbody class="commandeTable">
                            <!-- <tr>
                  <td>Tiger Nixon</td>
            ...
            <div class="historique historiqueZoneInactive" id="info">
                <div class="popupZone">
                    <i class="fa-solid fa-xmark closeHisto"></i>
                    <div class="historiqueZone">
                        <div class="histTitle">
                            <h3 class="titleHistorique">Infos Commande</h3>
                        </div>
                            ...
                            <table id="example" style="width:100%" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="titleTab2">qte Depart</th>
                                        <th class="titleTab2">Qte retourner</th>
                                        <th class="titleTab2">prix unitaire</th>
                                        <th class="titleTab2">montant</th>
                                    </tr>
                                </thead>
                                <tbody class="infoCommande">
                                    <!-- <tr>
                                    <td>Tiger Nixon</td>
                                    <td>System Architect</td>
                                    <td>System Architect</td>
    ...
    <script src="../../style/js/dashboard/commande.js"></script>
