...
<head>
    ...
    <link rel="stylesheet" href="../../style/css/dashboard/entrepot.css" />
...
<body>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Gerez votre entrepot ici</span>
                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="card-details">
                                <div class="name-number">
                                    <h6>Quantiter</h6>
                                    <input type="number" class="number" id="quantite" placeholder="la quantiter" required>
                                </div>
                                <input type="submit" value="envoyer" class="btnEnvoyer" id="button">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../../style/js/dashboard/entrepot.js"></script>
