...
<head>
    ...
    <title>Vos achats de <?php echo ($boutique->getNomBoutique()) ?></title>
</head>
...
<body>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Gerez vos Commandes Entrepot ici</span>
                </div>
                ...
                <div class="btnZone">
                    <a href="../form/ajouter_achat.php" title="Ajouter une vente">Nouvelle Commande</a>
                </div>
                ...
                <div class="inputZone">
                    <div class="inputs">
                        ...
                        <select name="" id="dateSelect">
                            <option value="1">Toutes les commande</option>
                            ...
                            <table id="example" style="width:100%" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="titleTab2">Qte recus</th>
                                    </tr>
                                </thead>
    ...
    <script src="../../style/js/dashboard/achat.js"></script>
