...
<body>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Gerez vos Dettes ici</span>
                </div>
                            ...
                            <div class="card l-bg-blue-dark">
                                <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <h5 class="card-title mb-0">Montant total des dettes</h5>
                            ...
                            <div class="card l-bg-green-dark">
                                <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <h5 class="card-title mb-0">Nombre de dette</h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card l-bg-green-dark">
                                <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="row align-items-center mb-2 d-flex">
                                        <div class="col-8">
                                            <h2 class="d-flex align-items-center mb-0 detteJournalier">
                                                --
                                            </h2>
                                        </div>
            ...
            <div class="btnZone">
                <a href="../form/ajouter_dette.php" title="Ajouter une vente">Nouvelle Dette</a>
            </div>
                ...
                <table id="example" style="width:100%" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="titleTab4">Total a Payer</th>
                            <th class="titleTab5">Reduction</th>
                            <th class="titleTab6">Montant apres reduction</th>
                            <th class="titleTab7">somme payer</th>
                            <th class="titleTab8">reste</th>
                            <th class="titleTab9">date echeance</th>
                            <th class="titleTab10">Liste Produit</th>
                            <th class="titleTab11">historique Payement</th>
                            <th class="titleTab12">Payement</th>
                            <th class="titleTab13">Recu</th>
                        </tr>
                    </thead>
                    <tbody class="detteTable">
                        <!-- <tr>
                  <td>Tiger Nixon</td>
                    ...
                    <div class="historiqueZone">
                        ...
                        <div class="table-responsive table-data">
                            <table id="example" style="width:100%" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th class="titleTab13">Date</th>
                                        <th class="titleTab14">somme</th>
                                    </tr>
                                </thead>
    ...
    <script src="../../style/js/dashboard/dette.js"></script>
