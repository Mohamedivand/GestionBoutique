...
<body>
    <div class="main">
        <header>
            <h6>Creez un proformat</h6>

            <a href="../dashboard/ProFormat.php">
        ...
        <div class="contenue">
            ...
            <form class="form partie2" id="formFinalVente">
                ...
                <div class="form2">
                    <h4>Les informations de l'offre</h4>
    ...
    <script src="../../style/js/Form/ajouter_proformat.js"></script>
</body>
