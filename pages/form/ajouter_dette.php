...
<body>
    <div class="main">
        <header>
            <h6>Effectuez une dette</h6>

            <a href="../dashboard/dette.php">
        ...
        <div class="contenue">
            ...
            <form class="form partie2" id="formFinalVente">
                <div class="typeVenteZone">
                    ...
                    <select name="" id="typeVente" required>
                ...
                <div action="" class="form2">
                    ...
                    <?php
                        $numUser = 0;
                        $query = $bdd->prepare("SELECT COUNT(idVente) AS nbrVente FROM vente WHERE id_boutique=?");
                ...
                <div action="" class="form2">
                    ...
                    <div class="inputZone" required>
                        ...
                        <input type="date" id="dateRemboursement" placeholder="Saisissez la date de paiment" required>
                    </div>
                </div>
    ...
    <script src="../../style/js/Form/ajouter_dette.js"></script>
</body>
