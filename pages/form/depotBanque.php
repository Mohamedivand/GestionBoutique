            ...
            <form action="#">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="number" placeholder="Entrer le montant  " id="montantDepot" min="1" required>
                    </div> 
                    <div class="input-box">
                        <span class="details">Numero compte</span>
                        <input type="num"  id="numCarte" disabled required>
                    </div> 
                    <div class="input-box">
                ...
                <div class="button">
                    <input type="submit" value="Enregistrer" id="btnDepot">
