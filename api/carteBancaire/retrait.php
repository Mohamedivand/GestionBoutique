<?php
    ...
    try{
        ...
        if(!isset($_POST['montant'], $_POST['motif'], $_POST['date'], $_POST['nomEmployer'], $_POST['numEmployer']) && !(isset($_POST['idCarte']) || isset($_POST['numeroCarte']))){
        ...
        if($carte->retrait($montant, $motif, $date, $nomEmployer, $numEmployer)){
